...
class BodyWeightExerciseDetails extends StatefulWidget {
  int ueindex;
  int eindex;
  int rindex;
  BodyWeightExerciseDetails(
      {Key? key,
  ...
  @override
  _BodyWeightExerciseDetailsState createState() => _BodyWeightExerciseDetailsState();
}

class _BodyWeightExerciseDetailsState extends State<BodyWeightExerciseDetails> {
