...
class Exercises {
  ...
  final double onerm;
  final int rest;
  Exercises({required this.name, required this.sets, required this.onerm, required this.rest});
  ...
  factory Exercises.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return Exercises(
        name: parsedJson["name"], sets: setList, onerm: parsedJson["onerm"], rest: parsedJson["rest"]);
  }
}
